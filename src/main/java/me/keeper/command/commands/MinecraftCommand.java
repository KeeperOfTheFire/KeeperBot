...
public class MinecraftCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        if(args.size() < 2){
            channel.sendMessage("Correct usage is: " + Config.get("prefix") + "minecraft uuid/names <username/uuid>").queue ();
            return;
        }
    ...
    public String getHelp() {
        return "get the UUID or name history of a player\n" +
                "Usage: " + Config.get("prefix") + "minecraft uuid/names <username/uuid>";
    }
